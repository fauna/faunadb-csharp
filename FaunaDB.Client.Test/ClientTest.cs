...
namespace Test
{
    ...
    public class ClientTest : TestCase
    {
        ...
        {
            var ex = Assert.ThrowsAsync<TransactionAbortedException>(
        ...
        {
            var ex = Assert.ThrowsAsync<InstanceNotFoundException>(
        ...
        public async Task TestDeleteAnInstance()
        {
            ...
            var ex = Assert.ThrowsAsync<InstanceNotFoundException>(async () => await client.Query(Get(@ref)));
        ...
        public async Task TestHandleConstraintViolations()
        {
            ...
            var ex = Assert.ThrowsAsync<InstanceNotUniqueException>(create);
