...
namespace FaunaDB.Client
{
    ...
    public class FaunaClient
    {
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="Client"/> with the specified arguments.
        /// </summary>
        ...
        /// <param name="clientIO">Optional <see cref="IClientIO"/>. Useful for testing purposes.</param>
        public FaunaClient(
            string secret,
        ...
        /// <summary>
        /// Creates a new <see cref="Client"/> with the user secret provided. Queries submitted to a session client will be
        /// authenticated with the secret provided. A session client shares its parent's internal object instances.
        /// </summary>
        /// <param name="secret">Auth token for the FaunaDB server.</param>
        ...
        /// </para>
        /// <para>
        /// See <see cref="Client.Query(Expr)"/> for more information on the individual queries.
        /// </para>
        /// </summary>
